...
export default function ResultsPage() {
  ...
  const totalResponses = useMemo(
    () => stats.reduce((sum, stat) => sum + stat.n, 0),
    [stats]
  )
        ...
        <header className="space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="space-y-2">
              <span className="inline-flex items-center gap-2 rounded-full border border-indigo-200/80 dark:border-indigo-500/30 bg-indigo-50/60 px-3 py-1 text-xs font-medium text-indigo-600 dark:text-indigo-200">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 max-w-2xl">
                Topic-level mastery, participation, and focus areas aligned with your latest diagnostic.
              </p>
            </div>
            <button
              onClick={loadResults}
